...
void Shader::setWindowSizeUniforms(GLFWwindow* window)
{
    ...
    int windowWidthLocation = glGetUniformLocation(ID, "windowWidth");
    int windowHeightLocation = glGetUniformLocation(ID, "windowHeight");
    glUniform1i(windowWidthLocation, windowWidth);
    glUniform1i(windowHeightLocation, windowHeight);
}
